...
import apiRest.modelo.endereco.Endereco;
...
public class AlunoDao {
	...
	public List<Aluno> getListaPorDisciplina(int codDisciplina) throws SQLException{	
		List<Aluno> alunos = new ArrayList<Aluno>();
		String sql = "select aluno.MatrAluno, aluno.Nome, aluno.NomeMae, aluno.DataNascimento, aluno.Rg, aluno.Cpf, aluno.Cidade, aluno.Bairro, aluno.Logradouro, aluno.Cep, aluno.Numero, aluno.Nome, disciplina.Nome from aluno inner join matricula on (matricula.Aluno = aluno.MatrAluno)inner join disciplina on(disciplina.CodDisciplina= matricula.Disciplina and disciplina.CodDisciplina = ?)";
		
		/*select aluno.MatrAluno, aluno.Nome, disciplina.Nome 
		from aluno inner join matricula on (matricula.Aluno = aluno.MatrAluno) 
		inner join disciplina on(disciplina.CodDisciplina= matricula.Disciplina and disciplina.CodDisciplina = 12);*/
